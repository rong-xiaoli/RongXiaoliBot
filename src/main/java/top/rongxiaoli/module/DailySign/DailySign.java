package top.rongxiaoli.module.DailySign;
...
import top.rongxiaoli.module.DailySign.ModuleBackend.SignIn.SignString;
...
public class DailySign extends Module {
    ...
    private class UserDataOperation {
        ...
        public void signInProcess() {
            User user = RongXiaoliBot.BotModuleLoader.DataBase.UserReadOrNull(userID);
            if (user == null) {
                // New user.
                isNew = true;
